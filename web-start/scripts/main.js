...
FriendlyChat.prototype.saveMessage = function(e) {
  ...
  if (this.messageInput.value && this.checkSignedInWithMessage()) {
    ...
    // check for giphy
    var regex = /^\/giphy (.*)/;
    var match = regex.exec(this.messageInput.value);
    if (match !== null) {
      //console.log(match[1]);
      ...
      client.get('https://api.giphy.com/v1/gifs/translate?s=' + match[1] + '&api_key=dc6zaTOxFJmzC', function(response) {
          ...
          messagesRef.push({
            ...
            imageUrl: obj.data.images.fixed_height.url,
            photoUrl: currentUser.photoURL || '/images/profile_placeholder.png'
          }).then(function() {
            // Clear message text field and SEND button state.
            FriendlyChat.resetMaterialTextfield(messageInput);
            //this.toggleButton();
...
FriendlyChat.prototype.HttpClient = function() {
